1. Press Install.bat to recieve and download all requirements under "requirements.txt"
2. Then run MainBot.py

!dmall [message]
to run

5 second (note:changing to less than 1 may cause lag)
